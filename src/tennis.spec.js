...
it("jugador 1 anota 2 y jugador 2 anota 2: 30 - 30", () => {
  let tennis = new Tennis();
  tennis.player1Scores();
  tennis.player1Scores();
  tennis.player2Scores();
...
it("jugador 1 anota 3 y jugador 2 anota 2: 40 - 30", () => {
  let tennis = new Tennis();
  tennis.player1Scores();
  tennis.player1Scores();
  tennis.player1Scores();
...
it("en Deuce jugador 1 anota: Advantage Player 1", () => {
  let tennis = new Tennis();
  tennis.player1Scores();
  tennis.player1Scores();
  tennis.player1Scores();
...
it("en Deuce jugador 2 anota: Advantage Player 2", () => {
  let tennis = new Tennis();
  tennis.player1Scores();
  tennis.player1Scores();
  tennis.player1Scores();
...
it("en Advantage Player 2, jugador 2 anota: Game for Player 2", () => {
  let tennis = new Tennis();
  tennis.player1Scores();
  tennis.player1Scores();
  tennis.player1Scores();
